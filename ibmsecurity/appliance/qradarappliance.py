...
class QRadarAppliance(IBMAppliance):
    def __init__(self, hostname, user, lmi_port=443):
        self.logger = logging.getLogger(__name__)
        self.logger.debug('Creating a QRadarAppliance')
    ...
    def _url(self, uri):
        # Build up the URL
        url = "https://" + self.hostname + ":" + str(self.lmi_port) + "/api" + uri
    ...
    def get_facts(self):
        ...
        try:
            ...
            import ibmsecurity.qradar.setup_complete
            ret_obj = ibmsecurity.qradar.setup_complete.get(self)
    ...
    def get_version(self):
        ...
        import ibmsecurity.qradar.firmware

        ret_obj = ibmsecurity.qradar.firmware.get(self)
    ...
    def get_activations(self):
        ...
        import ibmsecurity.qradar.activation

        ret_obj = ibmsecurity.qradar.activation.get(self)
